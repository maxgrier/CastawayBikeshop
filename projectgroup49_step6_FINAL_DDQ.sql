...
--
-- Host: mysql.eecs.oregonstate.edu    Database: cs340_nordstrb
-- ------------------------------------------------------
...
# ---------------------------------------------- #
# Drop existing tables before creating new       #
# ---------------------------------------------- #
...
CREATE TABLE `orders` (
    ...
    `order_date_year` int(11),
    `order_date_month` int(11),
    `order_date_dayOfMonth` int(11),
...
CREATE TABLE `employees` (
    ...
    `first_name` varchar(255) NOT NULL,
    `last_name` varchar(255) NOT NULL,
    `start_date_year` int(11),
    `start_date_month` int(11),
    `start_date_dayOfMonth` int(11),
